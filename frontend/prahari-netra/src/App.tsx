...
import {
  Activity, AlertTriangle, ArrowLeft, ArrowRight, BadgeCheck, Bell, Camera,
  ...
  Play, RefreshCw, Search, Settings2, ShieldCheck, SlidersHorizontal, Sparkles,
...
const navGroups: Array<{ label: string; items: Array<[string, string, typeof Activity]> }> = [
  { label: 'Command', items: [['/admin', 'Overview', Gauge], ['/admin/map', 'Operations map', MapIcon], ['/admin/cameras', 'Cameras', Camera], ['/admin/incidents', 'Incidents', Flag]] },
...
const cameraRecordings: Record<string, { visible: string; thermal: string }> = {
  'PN-LAD-04': { visible: '/recordings/frost-path.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-LAD-07': { visible: '/recordings/city-traffic.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-RAJ-02': { visible: '/recordings/vehicle-highway.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-RAJ-09': { visible: '/recordings/pedestrian-corridor.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-PUN-01': { visible: '/recordings/crowd-overhead.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-GUJ-06': { visible: '/recordings/vehicle-highway.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-WBE-03': { visible: '/recordings/crowd-overhead.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-SIK-02': { visible: '/recordings/frost-path.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-ARP-05': { visible: '/recordings/frost-path.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-ARP-08': { visible: '/recordings/pedestrian-corridor.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-ASM-04': { visible: '/recordings/city-traffic.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
  'PN-ASM-07': { visible: '/recordings/vehicle-highway.mp4', thermal: '/recordings/thermal-analysis-view.mp4' },
};
const defaultRecording = { visible: '/recordings/city-traffic.mp4', thermal: '/recordings/thermal-analysis-view.mp4' };
...
function CameraFeed({ cameraId, thermal = false, aiEnabled = true, className = '' }: { cameraId?: string; thermal?: boolean; aiEnabled?: boolean; className?: string }) {
  ...
  useEffect(() => {
    setSourceError(false); setDetections([]); setAiState(aiEnabled ? 'connecting' : 'off');
  ...
  useEffect(() => {
    ...
    const sendFrame = async () => {
      ...
      try {
        ...
        if (!cancelled) { setDetections(data.detections ?? []); setAiState('active'); setAiMessage('Local YOLO inference active'); }
      } catch (error) {
        if (!cancelled) { setAiState('error'); setAiMessage(error instanceof Error ? error.message : 'Inference service unavailable'); setDetections([]); }
